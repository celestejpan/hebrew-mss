        ...
        for $x in $collection
            ...
            if (string-length($msid) ne 0) then 
                ...
                return <doc>
                    ...
                    { bod:trueIfExists($x//tei:sourceDesc//tei:decoDesc/tei:decoNote[not(@type='none')], 'ms_deconote_b') }
                    ...
                    { bod:years($x//tei:origin//tei:origDate[@calendar = '#Gregorian' or (not(@calendar) and count(ancestor::tei:origin//tei:origDate) eq 1)]) }
